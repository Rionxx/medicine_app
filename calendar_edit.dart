...
import 'package:kenkyuu_medicine/Calendar/calendar_edit_model.dart';
...
class CalendarEditPage extends StatelessWidget {
  CalendarEditPage(
      ...
      this.titleText,
      this.date,
      this.mornningDrinkTime,
      this.morningDoasge,
      this.noonDrinkTime,
      this.noonDoasge,
      this.nightDrinkTime,
      this.nightDoasge,
      this.morningDrinkTimeId,
      this.noonDrinkId,
      this.nightDoasgeId,
  ...
  final String? date;
  final String? mornningDrinkTime;
  final String? morningDoasge;
  final String? noonDrinkTime;
  final String? noonDoasge;
  final String? nightDrinkTime;
  final String? nightDoasge;
  final int? morningDrinkTimeId;
  final int? noonDrinkId;
  final int? nightDoasgeId;
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<CalnedarEditModel>.value(
      value: CalnedarEditModel(
          id,
          titleText,
          date,
          mornningDrinkTime,
      ...
      child: Scaffold(
          ...
          body: Consumer<CalnedarEditModel>(builder: (context, model, child) {
  ...
  Widget titleTextFieldView(CalnedarEditModel model) {
    return Padding(
  ...
  Widget timeDrnkDrugTime(CalnedarEditModel model, BuildContext context) {
    return Container(
  ...
  Widget notificationSettingWidget(
      CalnedarEditModel model, BuildContext context) {
    return Padding(
  ...
  Widget updateButton(CalnedarEditModel model, BuildContext context) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Container(
        height: 50,
  ...
  // 追加ダイアログ
  Future updateDialog(CalnedarEditModel model, BuildContext context) async {
    try {
      model.update();
      await showDialog(
        context: context,
  ...
  Widget morningDosageBarWidget(CalnedarEditModel model, BuildContext context) {
    return Container(
      width: 100,
      height: 50,
      decoration: BoxDecoration(
  ...
  Widget noonDosageBarWidget(CalnedarEditModel model, BuildContext context) {
    return Container(
      width: 100,
      height: 50,
      decoration: BoxDecoration(
  ...
  Widget nightDosageBarWidget(CalnedarEditModel model, BuildContext context) {
    return Container(
      width: 100,
      height: 50,
      decoration: BoxDecoration(
  ...
  Widget noonDrinkTimeBarWidget(CalnedarEditModel model, BuildContext context) {
    return Container(
        width: 200,
        height: 50,
        decoration: BoxDecoration(
  ...
  _datePicker(BuildContext context, CalnedarEditModel model) async {
    ...
    if (datePicked != null && datePicked != model.toDay) {
      ...
      model.time = datePicked;
      model.setTimeText = _formatter.format(datePicked);
    }
  }

  Widget nightDrinkTimeBarWidget(
      CalnedarEditModel model, BuildContext context) {
    return Container(
        width: 200,
        height: 50,
